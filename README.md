...
The live app is available at [abrahamicbooks.org](https://abrahamicbooks.org/).

The Android APK can be downloaded from [the app website](https://abrahamicbooks.org/downloads/abrahamic-books-offline.apk).
